    ...
    <motion.div 
      ...
      <div className='flex flex-col xl:flex-row justify-between h-[620px] xl:h-full gap-x-4'>
        ...
        <div className='flex-1 h-[500px] flex flex-col justify-between overflow-y-scroll scrollbar-thin scrollbar-thumb-accent scrollbar-track-white/10 xl:pr-6'>
            ...
            {events.map(event =>{
                return (
                    <div key={event.id} className="flex flex-col xl:flex-row items-center justify-between gap-y-4  xl:gap-0 text-center xl:text-left my-4 xl:my-0 border-b border-white/10 pb-10 xl:py-3 last-of-type:border-none first-of-type:pt-0">
